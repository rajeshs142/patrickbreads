            ...
            <div class="panel-body">
                <form method="POST" action="/admin/product" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="image-url" class="form-control" type="file" name="image_url">
                        </div>
                    </div>
                    <div class="form-group d-none">
                        <label class="col-sm-2 control-label" for="thumb_url">@lang('messages.thumb_url')</label>
                        <div class="col-sm-10">
                            <input id="thumb_url" class="form-control" type="file" name="thumb_url">
                        </div>
                    </div>
                    <div class="form-group d-none">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="dimensions" class="form-control" type="text" name="dimensions" placeholder="Enter dimensions">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="serving_size">@lang('messages.serving_size')</label>
                        <div class="col-sm-10">
                            <input id="serving_size" class="form-control" type="text" name="serving_size" placeholder="Enter serving size">
                        </div>
                    </div>
                    <div class="form-group">
