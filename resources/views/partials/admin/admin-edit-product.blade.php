    ...
    <div class="col-md-10 offset-md-1 table-responsive">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="POST" action="/admin/product/{{ $product->id }}" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="image-url" class="form-control" type="text" name="image_url" placeholder="Enter image url" value="{{ $product->image_url }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="thumb_url">@lang('messages.thumb_url')</label>
                        <div class="col-sm-10">
                            <input id="thumb_url" class="form-control" type="text" name="thumb_url" placeholder="Enter thumb url" value="{{ $product->thumb_url }}">
                        </div>
                    </div>
                    <div class="form-group">
