...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $users = DB::table('users')
                  ...
                  ->get();
        return view('partials.admin.admin-add-product', ['category' => $category, 'users' => $users, 'sub_category' => $category, 'sub_category2' => $category]);
    }
    ...
    public function edit($id)
    {
        ...
        $product = new Product;
        $data = [ 'product' => $product->find($id), 'category' => $category, 'users' => $users, 'sub_category' => $category, 'sub_category2' => $category];
